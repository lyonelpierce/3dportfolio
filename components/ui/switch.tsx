...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-6 w-6 rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:bg-yellow-400 data-[state=checked]:translate-x-5 data-[state=unchecked]:bg-white data-[state=unchecked]:translate-x-0"
      )}
    />
  </SwitchPrimitives.Root>
));
